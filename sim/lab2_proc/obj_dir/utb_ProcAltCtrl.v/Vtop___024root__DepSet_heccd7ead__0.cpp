...
#endif
                VL_FATAL_MT("utb_ProcAltCtrl.v", 16, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("utb_ProcAltCtrl.v", 16, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("utb_ProcAltCtrl.v", 16, "", "NBA region did not converge.");
            }
