...
VL_ATTR_COLD void Vtop___024root___ctor_var_reset(Vtop___024root* vlSelf) {
    ...
    vlSelf->__Vtask_top__DOT__DUT__DOT__imul__DOT__control__DOT__tab__192__t_shamt = VL_RAND_RESET_I(5);
    vlSelf->__Vtask_top__DOT__DUT__DOT__imul__DOT__control__DOT__tab__192__t_add_mux_sel = VL_RAND_RESET_I(1);
    vlSelf->__Vtask_top__DOT__DUT__DOT__imul__DOT__control__DOT__tab__192__t_done = VL_RAND_RESET_I(1);
